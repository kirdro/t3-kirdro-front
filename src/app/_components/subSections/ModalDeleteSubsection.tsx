...
export const ModalDeleteSubsection: FC<IProps> = (props) => {
	...
	const { mutate, isPending } = api.subSection.deleteSubSection.useMutation({
		onSuccess: async () => {
			onClose();
	...
	return (
		<>
			<ModalHeader className='flex flex-col gap-1'>
				Удаление подраздела {nameSection} ({idSection})
			</ModalHeader>
			<ModalBody>
